...
@class AWKAnimatedImage;
@protocol AWKAnimatedImageViewDebugDelegate;


//
//  An `AWKAnimatedImageView` can take an `AWKAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface AWKAnimatedImageView : UIImageView
...
@property (nonatomic, strong) AWKAnimatedImage *animatedImage;
